...
const featuredProducts: ProductProps[] = [
  {
    ...
    description: "Climatizador de grande porte para ambientes industriais, ideal para galpões, fábricas e armazéns de grande escala.",
  ...
  },
  {
    ...
    description: "Solução de alta eficiência para médias indústrias, galpões e centros logísticos com ampla área de cobertura.",
  ...
  },
  {
    ...
    description: "Modelo potente e versátil para pequenas indústrias, oficinas e ambientes que necessitam de climatização eficiente.",
    ...
    <div className="min-h-screen">
      ...
      <section className="relative bg-primary text-white">
        ...
        <div
          ...
          style={{
            backgroundImage: 'url(https://images.unsplash.com/photo-1547895749-888a559fc2a7?q=80&w=2564&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D)'
          }}
        ></div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24 md:py-32 lg:py-40 relative z-10">
          <div className="max-w-3xl">
            ...
            <p className="text-xl md:text-2xl mb-8 text-gray-100 animate-fade-in" style={{ animationDelay: '0.2s' }}>
              Soluções avançadas para climatização de grandes ambientes com até 80% de economia de energia.
            </p>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div className="lg:order-2 animate-slide-in">
              ...
              <p className="text-gray-600 mb-6">
                A Guiasul é especializada no desenvolvimento e instalação de climatizadores industriais de alta performance 
                que proporcionam conforto térmico com baixo consumo energético para grandes ambientes como fábricas, 
                galpões logísticos, centros de distribuição e indústrias de diversos segmentos.
              </p>
              <p className="text-gray-600 mb-6">
                Nossos equipamentos são projetados para oferecer máxima eficiência em ambientes de grande porte, 
                utilizando tecnologia avançada de climatização evaporativa que garante redução significativa 
                nos custos operacionais quando comparados a sistemas de ar condicionado convencionais.
              </p>
            ...
            <div className="lg:order-1 flex justify-center animate-slide-in">
              <div className="relative w-full max-w-lg">
                <div className="absolute -top-4 -left-4 w-72 h-72 bg-secondary/20 rounded-full filter blur-3xl opacity-70"></div>
                <div className="absolute -bottom-4 -right-4 w-72 h-72 bg-primary/20 rounded-full filter blur-3xl opacity-70"></div>
                <img 
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mt-12">
            <div className="bg-white p-6 rounded-lg shadow-md hover:shadow-xl transition-shadow duration-300">
              ...
              <h3 className="text-xl font-bold mb-3 text-primary">Alta Performance</h3>
              <p className="text-gray-600">
                Climatizadores de alto desempenho com capacidade para atender grandes áreas industriais com eficiência energética.
              </p>
            </div>
            ...
            <div className="bg-white p-6 rounded-lg shadow-md hover:shadow-xl transition-shadow duration-300">
              ...
              <h3 className="text-xl font-bold mb-3 text-primary">Soluções Customizadas</h3>
              <p className="text-gray-600">
                Desenvolvimento de projetos personalizados de acordo com as características específicas de cada ambiente industrial.
              </p>
            </div>
            ...
            <div className="bg-white p-6 rounded-lg shadow-md hover:shadow-xl transition-shadow duration-300">
              ...
              <h3 className="text-xl font-bold mb-3 text-primary">Economia de Energia</h3>
              <p className="text-gray-600">
                Reduza em até 80% os custos de energia em comparação com sistemas de ar condicionado convencionais.
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="py-16 bg-gradient-to-r from-primary to-primary-light text-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h2 className="text-3xl md:text-4xl font-bold mb-6">Pronto para melhorar a climatização da sua indústria?</h2>
          <p className="text-xl mb-8 max-w-3xl mx-auto">
            Entre em contato com a Guiasul e descubra como nossos climatizadores industriais 
            podem proporcionar conforto térmico com alta eficiência energética.
          </p>
