...
const ProdutoDetalhe = () => {
  ...
  const caracteristicas = [
    { icon: "https://via.placeholder.com/40", label: 'Rotor em Aço Inox' },
    { icon: "https://via.placeholder.com/40", label: 'Painel Analógico de 10 Velocidades' },
    { icon: "https://via.placeholder.com/40", label: 'Produzido no Brasil' },
    { icon: "https://via.placeholder.com/40", label: 'Tensão T/F 220v | 380v | 440v' },
    { icon: "https://via.placeholder.com/40", label: '10 Velocidades' },
    { icon: "https://via.placeholder.com/40", label: 'Motores WEG' }
  ];

  // Opcionais disponíveis
  const opcionais = [
    { icon: "https://via.placeholder.com/60", label: 'Painel digital (IHM)' }
  ];
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="bg-white shadow-sm">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4 flex items-center gap-2 text-sm">
          ...
          <span className="text-primary font-medium">{produto.name}</span>
        </div>
      </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-2 space-y-8">
            <div className="bg-white rounded-lg shadow-md overflow-hidden">
              <div className="p-6">
                <h1 className="text-3xl font-bold text-primary mb-4">{produto.name}</h1>
            ...
            <div className="bg-white rounded-lg shadow-md overflow-hidden">
              ...
              >
                    ...
                    {especificacoes.map((spec, index) => (
                      <div key={index} className="flex">
                        ...
                        <div className="flex-grow border-b pb-3">
                          <h3 className="font-bold text-gray-800">{spec.label}</h3>
                ...
                <TabsContent value="aplicacoes" className="mt-0 p-6">
                  <h2 className="text-xl font-bold mb-4">Aplicações do Produto</h2>
                  <p className="mb-6">Veja alguns exemplos de aplicações desse produto:</p>
                ...
                <TabsContent value="opcionais" className="mt-0 p-6">
                  ...
                  <div className="mt-8">
                    ...
                    <div className="flex flex-wrap gap-3 items-center">
                      <img src="https://via.placeholder.com/80x40" alt="BNDES" className="h-8" />
                      <img src="https://via.placeholder.com/80x40" alt="Cartão de Crédito" className="h-8" />
                      <img src="https://via.placeholder.com/80x40" alt="Boleto" className="h-8" />
                    </div>
                    
                    <div className="mt-4">
                      <p className="text-sm text-gray-500">
                        Outras formas de pagamento: BNDES | PROGER | FINAME | LEASING
                      </p>
                    </div>
                  </div>
                </TabsContent>
          ...
          <div className="lg:col-span-1">
            <div className="bg-yellow-400 rounded-lg shadow-md overflow-hidden sticky top-24">
              <div className="p-6">
                <h2 className="text-xl font-bold mb-6">Solicitar orçamento deste produto:</h2>
                    ...
                    <FormField
                      ...
                      render={({ field }) => (
                        <FormItem>
                          ...
                          <FormControl>
                            <Input type="email" placeholder="E-mail *" required {...field} />
                          </FormControl>
                        </FormItem>
                      )}
                    />
                    ...
                    <FormField
                      ...
                      render={({ field }) => (
                        <FormItem>
                          ...
                          <FormControl>
                            <Input placeholder="Telefone ou celular *" required {...field} />
                          </FormControl>
                        </FormItem>
                      )}
                    />
                      ...
                      <FormField
                        ...
                        render={({ field }) => (
                          <FormItem>
                            ...
                            <FormControl>
                              <Input placeholder="Estado *" required {...field} />
                            </FormControl>
                          </FormItem>
                        )}
                      />
